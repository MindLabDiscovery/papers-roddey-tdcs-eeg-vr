...
%protocolfolder='D:\Box Sync\allen_erp_data'
...
%subjectfolder='D:\Box Sync\allen_erp_data\pro00087153_0005';

vrDataFolder=trialData.sessioninfo.path.vrfolder;
%vrDataFolder='D:\Box Sync\allen_erp_data\pro00087153_0005\vr';
%UNCOMMENT=======
subjectfolder=fullfile(protocolfolder,sbjnum);
vrDataFolder=fullfile(subjectfolder,'vr');
%UNCOMMENT>>>>>>> ffaf96856d6e8018a3ce114eb3094109948b6ab7
